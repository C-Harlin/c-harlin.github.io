...
<center>![](https://adversarial-ml-tutorial.org/introduction/pig.jpg)</center>

```html
<div style="text-align: right"><img src="https://adversarial-ml-tutorial.org/introduction/pig.jpg" width="100" /></div>
```
