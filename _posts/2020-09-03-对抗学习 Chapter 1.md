...
![center-aligned-image](https://adversarial-ml-tutorial.org/introduction/pig.jpg){: .align-center}

<img src="https://adversarial-ml-tutorial.org/introduction/pig.jpg" class="align-center" alt="">
...
其中$\Delta$表示允许的扰动.不过确定"正确"的扰动是件困难的事情:理论上,我们希望$\Delta$能够包含使得人类视觉上依然觉得"相同"的所有扰动,例如一点噪声,一点旋转,一点缩放等等,我们不可能从数学上给出所有扰动一个严格的定义.实际上,我们可以仅考虑所有扰动的一个子集,使得在这个子集下,图像的实际语义不会发生改变.常见的扰动集是$\ell_\infty$球($\ell_\infty$ ball):
