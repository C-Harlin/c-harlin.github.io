...
<!--more-->
## 背景
![Image](https://hackernoon.com/hn-images/1*8GQWP9Itkt6zELk7qexnfA.png){:.shadow}
...
简言之，soname的便利之处在于，当共享库进行小的版本升级时，只要将新的库文件链接到原来的soname即可，而相关程序无需任何修改，继续使用原有的soname就行。只有在遇到大的版本升级时才需要修改程序需要加载的soname。
